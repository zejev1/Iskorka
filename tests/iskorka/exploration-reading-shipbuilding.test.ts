...
const fresh = async (seed: string) => (await WorldEngine.create({profile:ISKORKA_PROFILE,worldId:seed, seed, store:new InMemoryWorldStore(), startTime:0})).snapshot();

describe('Iskorka local exploration, physical shipbuilding and reading', () => {
