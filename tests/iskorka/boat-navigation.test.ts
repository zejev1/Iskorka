...
async function setup() {
 const world=(await WorldEngine.create({profile:ISKORKA_PROFILE,worldId:'boat-water-test',seed:'boat-water-test',store:new InMemoryWorldStore(),startTime:0})).snapshot();
...
describe('Iskorka physical, voluntary boat navigation',()=>{
